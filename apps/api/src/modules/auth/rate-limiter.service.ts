...
// (e.g., 10/minute) given their abuse potential." A plain Redis fixed-window counter — simple
// and sufficient at this scale; a sliding-window log is the documented upgrade path if the
// windowing precision ever matters more than it does for three low-volume auth endpoints.
@Injectable()
